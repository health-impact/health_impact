...
PROMPT =  """
أعطني 5 نصائح صحية قصيرة ومفيدة للمجتمع الليبي بناءً على توصيات (WHO او CDC او NCDC).
...
"عند توليد كل نصيحة، يجب أن تلتزم بالتنسيق التالي بدقة:
العنوان: [عنوان النصيحة]
المجال: [اختر مجالاً واحداً فقط من المجالات العشرة، مثلاً: سلامة الغذاء]
المصدر: [اختر المصدر الأنسب للنصيحة فقط، مثلاً: WHO أو NCDC أو CDC]
التاريخ: [تاريخ اليوم]"
"""
