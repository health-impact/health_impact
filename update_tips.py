...
try:
    # 2. توليد بيانات جديدة تماماً
    print("🤖 توليد نصائح جديدة...")
    ...
    # 3. الكتابة القسرية (Override) لمسح النص الترحيبي القديم
    with open(file_path, 'w', encoding='utf-8') as f:
        json.dump(new_tips, f, ensure_ascii=False, indent=2)
    
    print(f"✅ تم تحديث الملف بـ {len(new_tips)} نصيحة جديدة.")
